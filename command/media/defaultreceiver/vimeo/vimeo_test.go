...
func TestMp4Extraction(t *testing.T) {
	cc := []struct {
	...
	}{
		{
			...
			expected: "https://gcs-vimeo.akamaized.net/exp=1529961460~acl=%2A%2F820169954.mp4%2A~hmac=df91aed8aa7cc15851e44ecbdbf3baa4906d6c9213539d51f6e7d5e6e73bf88c/vimeo-prod-skyfire-std-us/01/1356/9/231780045/820169954.mp4",
		},
		{
			body:     strings.NewReader(`e5129c1ec3cf5c996f77d883ad8453/238821524/video/853435837,853435913,853435901,853435825/master.m3u8","origin":"gcs"},"fastly_skyfire":{"url":"https://skyfire.vimeocdn.com/1529964151-0x626e27b83ed503bb96417a8a85643ad5106742a3/238821524/video/853435837,853435913,853435901,853435825/master.m3u8","origin":"gcs"}}},"progressive":[{"profile":175,"width":1920,"mime":"video/mp4","fps":30,"url":"https://fpdl.vimeocdn.com/vimeo-prod-skyfire-std-us/01/2764/9/238821524/853435913.mp4?token=1529964151-0x901607a1e3b3243c38d31be12c27d71548916b7b","cdn":"fastly","quality":"1080p","id":853435913,"origin":"gcs","height":1080},{"profile":165,"width":960,"mime":"video/mp4","fps":30,`),
			expected: "https://fpdl.vimeocdn.com/vimeo-prod-skyfire-std-us/01/2764/9/238821524/853435913.mp4?token=1529964151-0x901607a1e3b3243c38d31be12c27d71548916b7b",
		},
	}
	for _, c := range cc {
		got, err := extractMp4FromIframe(c.body)
		if got != c.expected {
			t.Errorf("got '%s', expected '%s'", got, c.expected)
		}
		if err != nil {
...
func TestIframeRequest(t *testing.T) {
	...
	for _, c := range cc {
		got, err := ExtractMp4(c.url, c.iframe)
